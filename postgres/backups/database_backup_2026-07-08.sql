...
ALTER TABLE public.issue_pin_id_seq OWNER TO gitea;
...
runtime-state	1	{"last_app_path":"/usr/local/bin/gitea","last_custom_conf":"/app/gitea/custom/conf/app.ini"}
\.
...
1	6	Microsoft SSO	t	t		{"Provider":"openidConnect","ClientID":"0f8c6b59-78fa-4426-a185-823e93ad2edf","ClientSecret":"dTU8Q~tbo~P2tQeAe4JmKEJZheP81k2M906brdaX","OpenIDConnectAutoDiscoveryURL":"https://login.microsoftonline.com/5055f54b-8147-447b-a3d1-72b105ed0cdc/v2.0/.well-known/openid-configuration","CustomURLMapping":{"AuthURL":"https://mastodon.social/"},"IconURL":"https://upload.wikimedia.org/wikipedia/commons/4/44/Microsoft_logo.svg","Scopes":["email profile"],"RequiredClaimName":"","RequiredClaimValue":"","GroupClaimName":"","AdminGroup":"","GroupTeamMap":"","GroupTeamMapRemoval":false,"RestrictedGroup":"","SSHPublicKeyClaimName":"","FullNameClaimName":""}	1783506538	1783507101
\.
...
1	0	git-credential-oauth	a4792ccc-144e-407e-86c9-5e7d8d9c3269		f	f	["http://127.0.0.1","https://127.0.0.1"]	1783074790	1783074790
2	0	Git Credential Manager	e90ee53c-94e2-48ac-9358-a874fb9e0662		f	f	["http://127.0.0.1","https://127.0.0.1"]	1783074790	1783074790
3	0	tea	d57cb8c4-630c-4168-8324-ec79935e18d4		f	f	["http://127.0.0.1","https://127.0.0.1"]	1783074790	1783074790
\.
...
1	revision		1	1783074791	1783074791
\.
...
COPY public.webhook (id, repo_id, owner_id, is_system_webhook, url, name, http_method, content_type, secret, events, is_active, type, meta, last_status, header_authorization_encrypted, created_unix, updated_unix) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.language_stat_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.repo_indexer_status_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.repo_redirect_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.repo_unit_id_seq', 16, true);
...
SELECT pg_catalog.setval('public.repository_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.watch_id_seq', 2, true);
...
--
-- Name: IDX_action_run_repo_concurrency; Type: INDEX; Schema: public; Owner: gitea
--

CREATE INDEX "IDX_action_run_repo_concurrency" ON public.action_run USING btree (repo_id, concurrency_group);
